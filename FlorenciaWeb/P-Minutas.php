                                              ...
                                              <div class="mu-latest-course-single">
                                                  ...
                                                  <div class="mu-latest-course-single-content">
                                                    ...
                                                    <script>
                                                        ...
                                                        var titu, raz, fech, tipor;

                                                        titu = document.getElementById("titulo").value;
                                                        raz = document.getElementById("razon").value;
                                                        fech = document.getElementById("fechev").value;
                                                        tipor = document.getElementById("tiporeu").value;

                                                            if(titu === "" || raz === "" || fech === "" || tipor === ""){
                                                      ...
                                                      <form  action="P-Minutas.php" method="post" class="contact100-form validate-form" onsubmit="return validarM();" >
                                                      ...
                                                      <div class="container-contact100">
                                                          <div class="wrap-contact100">
                                                                  ...
                                                                  <div class="wrap-input100 validate-input bg1" data-validate="Porfavor Escriba un Titulo">
                                                                      ...
                                                                      <input class="input100" type="text" required name="titulo" id="titulo"  placeholder="Ingrese el titulo de la vitacora">
                                                                  </div>

                                                                  <div class="wrap-input100 validate-input bg1" data-validate="Porfavor Ingrese una Razón">
                                                                      <span class="label-input100">Razón *</span>
                                                                      <input class="input100" type="text" required name="razon" id="razon" placeholder="Ingrese la razón de la Vitacora ">
                                                                  </div>
                                                                   ...
                                                                   <div class="wrap-input100 validate-input bg1" data-validate="Porfavor Ingrese una Fecha Valida">
                                                                    ...
                                                                    <input type="date" required name="fechev" id="fechev" step="1" min="2020-05-01" max="2050-12-31" >
                                                                  ...
                                                                  <div class="wrap-input100 input100-select bg1">
                                                                      ...
                                                                      <div>
                                                                          <select required style="width:300px;" required class="js-select2" name="tiporeu" id="tiporeu">
                                                                  ...
                                                                  <div>
                                                                        ...
                                                                        <form action="/action_page.php" onsubmit="return validarM();">
