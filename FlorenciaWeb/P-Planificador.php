                                                    ...
                                                    <!-- Metodo que llama el nombre y ramo impartido del profesor de la sesión actual --> 
                                                      ...
                                                      <br />
                                                            ...
                                                            function validarP(){
                                                                ...
                                                                titu = document.getElementById("tituloev").value;
                                                                fech = document.getElementById("fechev").value;
                                                                tip = document.getElementById("tipoev").value;
                                                                    ...
                                                                    if (titu === "" || fech === "" || tip === "") {
                                                                        ...
                                                                        alert ("[ ✓ ] Planificación Enviada Correctamente!")
                                                                        return true;
                                                                    }
                                                      ...
                                                      <label for="cursos">Cursos a Cargo: </label>
                                                        <form action="P-Planificador.php" method="post"   class="contact100-form validate-form" onsubmit="return validarP();">
                                                      ...
                                                      <div class="container-contact100">
                                                          <div class="wrap-contact100">
                                                                  ...
                                                                  <div class="wrap-input100 validate-input bg1" data-validate="Porfavor Escriba un Titulo">
                                                                      ...
                                                                      <input class="input100" type="text" name="tituloev" id="tituloev" required placeholder="Ingrese el titulo de la Evaluación">
                                                                  </div>
                                                                  ...
                                                                  <div class="wrap-input100 validate-input bg1" data-validate="Porfavor Ingrese una Fecha Valida">
                                                                    ...
                                                                    <input type="date" name="fechev" id="fechev" step="1" required min="2020-05-01" max="2050-12-31" >
                                                                  ...
                                                                  <div class="wrap-input100 input100-select bg1">
                                                                      ...
                                                                      <div>
                                                                          <select style="width:300px;" required class="js-select2" name="tipoev" id="tipoev">
                                                                  ...
                                                                  <div class="wrap-input100 validate-input bg0 rs1-alert-validate" data-validate="Porfavor Escrba los de la Evaluación">
                                                                      ...
                                                                      <textarea class="input100" required name="objetivos" placeholder="Ingrese los Objetivos a Lograr..."></textarea>
                                                                  </div>
                                                                  ...
                                                                  <div>
                                                                      ...
                                                                      <form action="/action_page.php" onsubmit="return validarP();" >
